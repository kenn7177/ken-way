  ...
  return (
    <MotionConfig reducedMotion={reduced ? "always" : "user"}>
      ...
      >
        ...
        {mode === "demo" && <div className="demo-banner"><span>体验模式 · 示例数据</span><div><button onClick={() => openSheet("experience")}>体验工具</button><button onClick={() => switchMode("personal")}>退出体验</button></div></div>}
